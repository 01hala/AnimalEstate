...
namespace abelkhan
{
    ...
    public class DBQueryHelper
    {
        ...
        public DBQueryHelper elemListMatchEq(string key, long t)
        {
        ...
        public DBQueryHelper elemListMatchEq(string key, int t)
        {
            var _condition = new BsonDocument("$eq", t);
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$elemMatch", _condition)));
            return this;
        ...
        public DBQueryHelper elemListMatchEq(string key, uint t)
        {
            var _condition = new BsonDocument("$eq", t);
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$elemMatch", _condition)));
            return this;
        ...
        public DBQueryHelper elemListMatchEq(string key, float t)
        {
            var _condition = new BsonDocument("$eq", t);
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$elemMatch", _condition)));
            return this;
        ...
        public DBQueryHelper elemListMatchEq(string key, double t)
        {
            var _condition = new BsonDocument("$eq", t);
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$elemMatch", _condition)));
            return this;
        ...
        public DBQueryHelper elemListMatchEq(string key, string t)
        {
            var _condition = new BsonDocument("$eq", t);
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$elemMatch", _condition)));
            return this;
        ...
        public DBQueryHelper lte(string key, long t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$lte", t)));
            return this;
        }

        public DBQueryHelper lte(string key, int t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$lte", t)));
            return this;
        }

        public DBQueryHelper lte(string key, uint t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$lte", t)));
            return this;
        }

        public DBQueryHelper lte(string key, float t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$lte", t)));
            return this;
        }

        public DBQueryHelper lte(string key, double t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$lte", t)));
            return this;
        }

        public DBQueryHelper gte(string key, long t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$gte", t)));
            return this;
        }

        public DBQueryHelper gte(string key, int t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$gte", t)));
            return this;
        }

        public DBQueryHelper gte(string key, uint t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$gte", t)));
            return this;
        }

        public DBQueryHelper gte(string key, float t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$gte", t)));
            return this;
        }

        public DBQueryHelper gte(string key, double t)
        {
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$gte", t)));
            return this;
        }

        public DBQueryHelper In<T>(string key, List<T> t)
        {
            var array = new BsonArray(t);
            query_condition.Add(new KeyValuePair<string, BsonValue>(key, new BsonDocument("$in", array)));
            return this;
        }
