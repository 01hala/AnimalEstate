...
namespace hub
{
    ...
    public class gatemanager
	{
        ...
        public void call_group_client(List<string> uuids, String func, ArrayList _argvs_list)
        {
            ...
            using var st_event = constant.constant.rcStMgr.GetStream();
            ...
            using var st_send = constant.constant.rcStMgr.GetStream();
            ...
            using var st_send_crypt = constant.constant.rcStMgr.GetStream();
